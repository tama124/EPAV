...
public class Metasploit {
	...
	public String runMetasploit(String lhost, String rhost, String rootPass,
			String checkedVulName) throws Exception {
		...
		for (String data : dataBase) {
			if (data.contains(checkedVulName.substring(0,
					checkedVulName.length()).replace(".sh", ""))) {
